...
public class AgeCategory {
	 ...
	 * @throws BadStringException 
		 */
	public AgeCategory(String name, int min, int max) throws BadParametersException,  BadStringException{
	 ...
	 * @uml.property name="name"
	 */
	public void setName(String name) throws BadStringException {
