...
// search for the age category by name
	...
	// Modify an age category 
			...
			public void modify(String name, int max,int min) throws AgeCategoryExistsException, AgeCategoryOverLapException, BadParametersException, EmptyStringException {
				EntityManager entityManager=JPAUtil.getEntityManager();
