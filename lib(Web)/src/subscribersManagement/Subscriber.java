...
public class Subscriber implements Serializable {
	 ...
	 *                     inverse="lender:java.util.ArrayList"
	 */
	// @Transient
	 ...
	 * @uml.associationEnd multiplicity="(0 -1)" ordering="true"
	 *                     inverse="mainSubscriber:subscribersManagement.Entitled"
	 ...
	 *                     inverse="subscribers:subscribersManagement.AgeCategory"
	 */
	@ManyToOne
...
//	 private static int numberCreated=0;
	 ...
	 * @uml.associationEnd multiplicity="(0 -1)" ordering="true"
	 *                     inverse="subscriber:reservationManagement.Reservation"
	 */
